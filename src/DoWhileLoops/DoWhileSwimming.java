...
public class DoWhileSwimming {
    public static void main( String[] args ) throws Exception
    {
        ...
        //They both swim for the same amount of time.
        //When the temperature is dropped to 78 Goofus swims for 1 minute but Gallant doesn't swim at all.
        //The while-loop is the pre-test look and the do-while-loop is the post-test loop.
}
}
